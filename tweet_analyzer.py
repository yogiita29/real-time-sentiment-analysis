...
positive_words = ' '.join(positive_tweets['cleaned_text'].astype(str).tolist())
negative_words = ' '.join(negative_tweets['cleaned_text'].astype(str).tolist())
...
all_words = ' '.join(df['cleaned_text'].astype(str).tolist()).split()
